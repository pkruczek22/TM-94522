...
3. **Migracja do biblioteki urllib3 / Requests**: W celu pełnej integracji z API raportowania, rekomenduję zastąpienie standardowych wywołań systemowych dedykowanym klientem HTTP, co pozwoli na przesyłanie logów audytu bezpośrednio do zewnętrznego serwera zbierającego metryki.
4. **Wprowadzenie Metodologii "Dry Run"**: Dodanie przełącznika w konfiguracji, który pozwala na weryfikację spójności selektorów w pliku JSON bez konieczności uruchamiania pełnego zestawu testów funkcjonalnych (tzw. Smoke Audit).

---
**Podpisano:**
*Inżynier Testów:* **Paweł Kruczek**
*Numer Albumu:* `94522`
*Data: 28.03.2026* 
